...
database = 'EscolaApp_04102021.db'

@app.route("/")
def index():
    return ("Aplicação Serviço Escola para Projeto #2 - HTTP Desenvolvido por Emanuel Gomes para disciplina de Protocolos de Interconexão de Redes 2021.2. ", 200)
